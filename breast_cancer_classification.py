...
Original file is located at
    https://colab.research.google.com/drive/19_ezeEF9_N8yb6qMX63jTzINWyg_dTdt
...
# # Display some images of moles, and how they are classified
w=60
h=40
...
for i in range(len(prop_class)):
    ...
    ax.set_title("Predicted result:"+ class_name(np.argmax(Y_pred_tta[prop_class[i]]))
                       +"\n"+"Actual result: "+ class_name(np.argmax(Y_test[prop_class[i]])))
